...
var headers = ['State', 'Brand', 'License Plate', 'Valid From', 'Valid Until'];
var elTableHeaders = headers.map(function (header) {
...
var fetchVehicles = fetch('https://dwaapi.juvasquez88.now.sh/soatdwa').then(function (response) {
...
var isValidSoat = function isValidSoat(from, until) {
...
var generateVehicleRows = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return _context.abrupt("return", vehicles.map(function (_ref3) {
              var brand = _ref3.brand,
                  licensePlate = _ref3.licensePlate,
                  soatValidFrom = _ref3.soatValidFrom,
                  soatValidUntil = _ref3.soatValidUntil;
              var fromDate = new Date(parseInt(soatValidFrom));
              var untilDate = new Date(parseInt(soatValidUntil));
              var state = createElement('td', {
                "class": isValidSoat(fromDate, untilDate) ? 'valid' : 'invalid'
              }, ['']);
              var brandEl = createElement('td', {
                "class": ''
              }, [brand]);
              var license = createElement('td', {
                "class": ''
              }, [licensePlate]);
              var from = createElement('td', {
                "class": ''
              }, [formatDate(fromDate)]);
              var until = createElement('td', {
                "class": ''
  ...
  return function generateVehicleRows() {
...
generateVehicleRows().then(function (vehicles) {
